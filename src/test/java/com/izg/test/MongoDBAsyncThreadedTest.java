...
* @author npina
*
* This tests inserts a json object in a mongodb using the async driver
...
*/
public class MongoDBAsyncThreadedTest {
        ...
        Callable<List<String>> insertTask = new Callable<List<String>>() {
            public List<String> call() {
            	...
            	for(;i<insertsPerThread;i++) {
            		...
            		DocumentBuilder doc = BuilderFactory.start().add("_id", id).add("json",json);
	    			Future<Integer> insertAsync = collection.insertAsync(	doc);
	    			ids.add(id);
	    			futures.add(insertAsync);
            	}
