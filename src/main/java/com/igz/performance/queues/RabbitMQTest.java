...
public class RabbitMQTest {
	...
	public static void main(String[] args) throws Throwable {
		...
		List<RabbitMQConsumer> consumers = new ArrayList<RabbitMQConsumer>();
		for (int i = 0; i < CONSUMER_COUNT; i++) {
			RabbitMQConsumer consumer = new RabbitMQConsumer("C" + i, QUEUE_NAME, getDatabaseDAO(), JSON);
		...
		List<Callable<List<String>>> producers = new ArrayList<Callable<List<String>>>();
